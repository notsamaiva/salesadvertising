...
const PriceCard = ({ 
  ...
  const benefits = [
    'Showcasing your products and services onthe FlyStore',
    'Strategic placement of your banners or videoads on the FlyPool app',
    '06 display banner ads, sponsored ads, pop-ups, etc.',
    'Personalize your advertising message',
    'Advanced targeting tools to reach youridealaudience',
